...
class Config(object):
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME", "auto_renamer")     
    DB_URL  = os.environ.get("DB_URL", "")
 
    # other configs
    ADMIN_URL = "https://t.me/a"
    DUMP = True
    DUMP_CHANNEL = int(os.getenv("DUMP_CHANNEL", "-1003851627280"))
...
❍ ᴅᴇᴠᴇʟᴏᴩᴇʀ : <a href="https://t.me/">ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
...
❍ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/">ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
